...
<fmt:bundle basename="TestBundle">
	<title>Last Ever - Referee Schedule<fmt:message key="div_head2" /></title>
</fmt:bundle>
</head>
<body>
	<fmt:bundle basename="TestBundle">
	...
	-->
		...
		<!-- Calendar functionality for referee - Outer Layer -->
		<div class="main-cover">
			...
			<div class="cards-container container">
				...
				<a href="./refCreateSchedule" class="btn btn-success"><fmt:message
						key="as_add" /></a>
				<div class="row">
