...
<fmt:bundle basename="TestBundle">
    ...
    -->
		<div class="cards-container container">
			...
			<div class="row">
				<c:if test="${user.emailValidated eq 0}">
					<div class="col-lg-12 mb-5">
						<div class="card">
							<h4 class="card-header"><fmt:message key="email_activation_head" /></h4>
							<div class="card-body">
								<fmt:message key="admin_activation_hello" />
								<br><br>
								<fmt:message key="email_activation_body1" /> <a href="./resendEmail?id=${user.id}"><fmt:message key="email_activation_click" /> </a> <fmt:message key="email_activation_body2" />
								<br><br>
				...
				<c:if test="${user.adminActivated eq 0}">
					<div class="col-lg-12 mb-5">
						<div class="card">
