...
<title>....... <fmt:message key="header_title" /> .......
</title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<!-- 
						FUTURE DEVELOPMENT
						Make the CURRENT PAGE link active
						 -->
								...
								<c:choose>
									...
									<c:when test="${userType == './referee'}">
										<li class="nav-item dropdown"><a
											...
											<div class="dropdown-menu dropdown-menu-right"
												aria-labelledby="navbarDropdownPortfolio">
												<a class="dropdown-item" href="${userType}">${userName}'s
													Home</a> <a class="dropdown-item" href="logout"><fmt:message
														key="team_dd4" /></a>
											</div></li>
									</c:when>
								</c:choose>
