		...
		<div class="main-cover">
			...
			<div class="cards-container container">
				...
				<form action="./adminEmails" method="POST">
					<button type="submit" class="btn btn-success"><fmt:message key="ae_email_all" /></button>
				</form>
				<div class="row">
						    ...
						    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
						      <div class="card-body">
						      	<form action="./adminEmails?=1" method="POST">
									...
									<hr />
									<button type="submit" class="btn btn-outline-dark"><fmt:message key="ae_send" /></button>
						      	</form>						      							      							        
						      </div>
						    </div>
						  </div>
