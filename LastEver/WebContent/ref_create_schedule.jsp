...
<fmt:bundle basename="TestBundle">
	<title>Last Ever - Referee Create Schedule<fmt:message key="admin_title_cs" /></title>
</fmt:bundle>
</head>
<body>
	<fmt:bundle basename="TestBundle">
		...
		<!-- Referee Calendar - Actual Breakdown -->
				...
				<div class="row">
					<div class="col-lg-12 mb-4">
						<div class="card h-100">
							...
							<form action="refCreateSchedule" method="POST">
								<div class="card-body">
									...
									<div class="form-group">
										<label for="newGameStatus"><fmt:message
											...
											name="newGameStatus">
											<option value="Final"><fmt:message key="final" /></option>
											<option value="Scheduled" selected><fmt:message key="scheduled" /></option>
										</select>
									</div>
								</div>
