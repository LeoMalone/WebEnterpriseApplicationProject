			...
			<div class="row">
				<div class="col-lg-4 mb-4">
					<div class="card h-100">
						...
						<div class="card-body">
							<p class="card-text">
								This league is located at the Sporting Stadium in Ottawa,
								Ontario. <br />
								<br />
								<b>Any special info to share about the league</b>
							</p>
						</div>
				...
				<div class="col-lg-4 mb-4">
					<div class="card h-100">
						<h4 class="card-header">Rule Summary</h4>
						<div class="card-body">
