...
<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu dropdown-menu-right"
						...
						<a class="dropdown-item" href="about.jsp"><fmt:message key="about" /></a> <a
							...
							class="dropdown-item active" href="contact.jsp"><fmt:message key="contact" /></a>
					</div></li>
				<li class="nav-item dropdown"><a
    ...
    <div class="main-cover">    	
		...
		<div class="cards-container container">
	    	<fmt:bundle basename="TestBundle">
	    	<h1 class="my-4"><fmt:message key="contact_header"/></h1>
			<!-- Marketing Icons Section -->
			<div class="row">
			  <div class="col-lg-4 mb-4">
			    <div class="card h-100">
			      <h4 class="card-header"><fmt:message key="contact_head1"/></h4>
			      <div class="card-body">
			        <p class="card-text"><fmt:message key="contact_text1"/></p>
			      </div>
			    </div>
			  </div>
			</div>
